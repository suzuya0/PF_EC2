...
ActiveRecord::Schema.define(version: 2021_10_10_071538) do

  create_table "bartered_item_comments", force: :cascade do |t|
  ...
  create_table "wanted_item_images", force: :cascade do |t|
